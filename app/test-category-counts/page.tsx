...
export default function TestCategoryCountsPage() {
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">
              Test Cập nhật số lượng sản phẩm trong danh mục
            </h1>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              ...
              <li>• Danh mục "Thuốc dành loãng xương" sẽ hiển thị số lượng sản phẩm đúng sau khi cập nhật</li>
            </ul>
          </div>
        </div>
      </main>
