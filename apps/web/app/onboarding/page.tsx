...
export default function OnboardingPage() {
  ...
  const calculateWeightLoss = () => {
    ...
    return parseFloat(userData.currentWeight) - parseFloat(userData.targetWeight)
  }

  const calculateCalories = () => {
    if (!userData.currentWeight || !userData.age || !userData.gender || !userData.height) return 2000
    ...
    const multiplier = activityMultipliers[userData.activityLevel as keyof typeof activityMultipliers] || 1.2
  ...
  const completeOnboarding = async () => {
    ...
    try {
      ...
      // Chuyển đến dashboard sau 3 giây
      setTimeout(() => {
        router.push('/dashboard');
      }, 3000);
